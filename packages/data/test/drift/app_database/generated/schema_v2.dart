...
class UserEvents extends Table with TableInfo<UserEvents, UserEventsData> {
  ...
  late final GeneratedColumn<bool> isRecurringMaster = GeneratedColumn<bool>(
    'is_recurring_master',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  UserEventsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserEventsData(
      ...
      isRecurringMaster: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_recurring_master'],
      )!,
...
class UserEventsData extends DataClass implements Insertable<UserEventsData> {
  ...
  const UserEventsData({
    ...
    required this.isRecurringMaster,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_recurring_master'] = Variable<bool>(isRecurringMaster);
  ...
  UserEventsCompanion toCompanion(bool nullToAbsent) {
    return UserEventsCompanion(
      ...
      isRecurringMaster: Value(isRecurringMaster),
  ...
  factory UserEventsData.fromJson(
    ...
    return UserEventsData(
      ...
      isRecurringMaster: serializer.fromJson<bool>(json['isRecurringMaster']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isRecurringMaster': serializer.toJson<bool>(isRecurringMaster),
  ...
  UserEventsData copyWith({
    ...
    recurrenceCount: recurrenceCount.present
        ...
        : this.recurrenceCount,
    isRecurringMaster: isRecurringMaster ?? this.isRecurringMaster,
  ...
  UserEventsData copyWithCompanion(UserEventsCompanion data) {
    return UserEventsData(
      ...
      recurrenceCount: data.recurrenceCount.present
          ...
          : this.recurrenceCount,
      isRecurringMaster: data.isRecurringMaster.present
          ? data.isRecurringMaster.value
          : this.isRecurringMaster,
  ...
  String toString() {
    return (StringBuffer('UserEventsData(')
          ...
          ..write('isRecurringMaster: $isRecurringMaster, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is UserEventsData &&
          ...
          other.isRecurringMaster == this.isRecurringMaster &&
...
class UserEventsCompanion extends UpdateCompanion<UserEventsData> {
  ...
  final Value<bool> isRecurringMaster;
  ...
  const UserEventsCompanion({
    ...
    this.isRecurringMaster = const Value.absent(),
  ...
  static Insertable<UserEventsData> custom({
    ...
    Expression<bool>? isRecurringMaster,
    ...
    return RawValuesInsertable({
      ...
      if (isRecurringMaster != null) 'is_recurring_master': isRecurringMaster,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isRecurringMaster.present) {
      map['is_recurring_master'] = Variable<bool>(isRecurringMaster.value);
    }
